...
public sealed partial class XenoAidComponent : Component
{
    ...
    [DataField, AutoNetworkedField]
    public ProtoId<StatusEffectPrototype>[] AilmentsRemove = ["KnockedDown", "Stun", "Dazed", "Unconscious"]; // Mriya. ["KnockedDown", "Stun"] в оригіналі, фікс абілки відповідно до Валькірії
