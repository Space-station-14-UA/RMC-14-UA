...
{
    public partial interface IServerDbManager // mriya partial interface is in a separate file
    {
        void Init();
    ...
    public sealed partial class ServerDbManager : IServerDbManager // mriya partial class is in a separate file
    {
