...
//        if (!TryComp(uid, out HandsComponent? hands) || hands.Count <= 0) – Mriya. Дайте жукам махати крилами без рук. Прибрати, як буде додано нью-мед та можливість нормально відривати кінцівки
//            return false;
