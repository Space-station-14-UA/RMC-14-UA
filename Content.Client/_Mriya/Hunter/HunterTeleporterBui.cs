...
[UsedImplicitly]
public sealed class HunterTeleporterBui(EntityUid owner, Enum uiKey) : RMCPopOutBui<TacticalMapWindow>(owner, uiKey)
{
    ...
    protected override void Open()
    {
        ...
        else if (EntMan.System<SharedTacticalMapSystem>().TryGetTacticalMap(out var map))
        {
            mapEntity = map.Owner;
        }
        ...
        Window.Wrapper.Map.OnQueenEyeMove += position => SendPredictedMessage(new HunterTeleportRequestMsg(position));
    }
