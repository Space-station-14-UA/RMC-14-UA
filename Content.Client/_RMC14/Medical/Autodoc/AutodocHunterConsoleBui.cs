...
[UsedImplicitly]
public sealed class AutodocHunterConsoleBui(EntityUid owner, Enum uiKey) : BoundUserInterface(owner, uiKey)
{
    [ViewVariables]
    private AutodocHunterConsoleWindow? _window;

    protected override void Open()
    {
        base.Open();

        _window = this.CreateWindow<AutodocHunterConsoleWindow>();
