...
public sealed partial class AutodocHunterConsoleWindow : DefaultWindow
{
    ...
    private AutodocHunterConsoleBui? _bui;

    public AutodocHunterConsoleWindow()
    {
    ...
    public void SetBui(AutodocHunterConsoleBui bui)
    {
        _bui = bui;
    }
