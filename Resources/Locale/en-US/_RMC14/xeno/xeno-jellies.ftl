...
rmc-jelly-special-1 = Королевське Желе Потужності Верховної Королеви
...
rmc-hivemanagement-exchange-larva = Обміняти лярви на очки еволюції
rmc-hivemanagement-exchange-larva-not-enough = Нам треба як мінімум 1 схована лярва, щоб обміняти її на очки еволюції!
rmc-hivemanagement-exchange-larva-title = Дати Очки Еволюції
rmc-hivemanagement-exchange-larva-description = Виберіть ксеноїда, якому дати {$points} очок
  еволюції за сховану лярву
rmc-hivemanagement-exchange-larva-need-minutes = Ми повинні дати лярвам трохи часу на появу, перш ніж приносити їх у жертву. Будь ласка, зачекайте ще {$minutes} хвилин
rmc-hivemanagement-exchange-larva-given-user = {$target} отримала {$points} очок еволюції.
rmc-hivemanagement-exchange-larva-given-target = {$user} дала нам {$points} очок еволюції! Використайте їх з користю.
...
rmc-hivemanagement-manage-teams = Керувати Командами Вулика
