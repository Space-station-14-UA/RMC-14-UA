...
cm-job-name-ordnance-tech = Інженер-Зброяр
cm-job-description-ordnance-tech = Зробіть особливу зброю для морпіхів. Обслуговуйте орбітальну гармату та шатли.
cm-job-prefix-ordnance-tech = ІО
CMJobOrdnanceTech = Інженер-Зброяр

cm-job-name-maint-tech = Обслуговуючий Інженер
cm-job-description-maint-tech = Підтримуйте реактори корабля в робочому стані. Лагодьте і модифікуйте корабель та шатли.
