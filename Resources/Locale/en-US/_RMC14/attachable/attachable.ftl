...
rmc-attachable-examine-condition-whitelist-tags = [bold]має {$tagNumber}[/bold] наступну мітку: [bold]{$tags}[/bold]

rmc-attachable-examine-condition-blacklist-comps = [bold]бракує {$compNumber}[/bold] з наступних компонентів: [bold]{$comps}[/bold]
...
rmc-attachable-examine-size = [color={$colour}]{$sign}{$size}[/color] розмір предмету.

rmc-attachable-examine-speed-walk = [color={$colour}]{$sign}{TOSTRING($speed, "F2")}[/color] множник швидкості ходьби.
